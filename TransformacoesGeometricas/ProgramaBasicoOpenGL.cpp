...
void CriaInstancias()
{
    ...
    Personagens[0].modelo = DesenhaApontador;
    Personagens[0].Escala = Ponto (0.4,0.4);
    ...
    Personagens[1].Posicao = -Meio;
    Personagens[1].Rotacao = 0;
    Personagens[1].modelo = DesenhaRS;
    
    Personagens[2].Posicao = Ponto (0,-5);
    Personagens[2].Rotacao = 0;
    Personagens[2].modelo = DesenhaApontador;
...
void display( void )
{
    ...
    DesenhaEixos();
    //CalculaMovimentosDosPersonagens();
